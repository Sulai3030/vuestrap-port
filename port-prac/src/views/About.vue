<template>
  <div>
    <b-card-group align:center>
      <b-card-text>
        <p align="left" style="max-width: 50rem;" padding="300px" class="text-center">
          ...
          New York State. A flexible and quick learner committed to constantly
          learning and evolving his skills to stay abreast of ever-evolving
          technologies and trends in the industry. Communicative, knowledgeable
          and steadfast with excellent computer engineering skills learned in
          the Columbia University Coding Bootcamp where he created projects in
          HTML5, CSS, JavaScript, VueJS, and ReactJS.
        </p>
      </b-card-text>
